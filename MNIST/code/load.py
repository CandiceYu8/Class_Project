...
file1 = "E:\\school\\2-2\\AI\\Project1\\train-images.idx3-ubyte"
file2 = "E:\\school\\2-2\\AI\\Project1\\train-labels.idx1-ubyte"

imgs, data_head = loadImageSet(file1)
print('data_head:', data_head)
print("images' type: " + str(type(imgs)))
